# Contributing to LlamaArt

Thank you for your interest in contributing to LlamaArt! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaArt:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamaArt.git
   cd llamaArt
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamaArt.git
   ```
...
By contributing to LlamaArt, you agree that your contributions will be licensed under the project's MIT License.
